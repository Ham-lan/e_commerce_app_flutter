/*
Add this key into your ios/Runner/GoogleService-Info.plist
* <key>API_KEY</key>
	<string>AIzaSyAliAEXqhXWMq8HkoNvnZKHBKNfPeEK7_g</string>
* */
...
import 'package:project/Data/Repositories/Firebase/FirebaseUserRepository.dart';
...
void main() async {
  ...
  getIt.registerFactoryParam<LoginScreenCubit , LoginScreenInitialParams , dynamic>((params, _)
  => LoginScreenCubit(
      params,
      getIt()
  ) );
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LoginScreenPage(cubit: getIt(param1: LoginScreenInitialParams()) ) ,
    );
  }
}
